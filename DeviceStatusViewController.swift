            ...
            if let data = response.data {
                ...
                if(json["updates"].count > 0) {
                    ...
                    for i in 0...(json["updates"].count - 1) {
                        ...
                        let _time_stamp = json["updates"][i]["created_at"].stringValue
                        
                        
                        let _update = Update(content: _content, status: _status, check_in_id: _check_in_id!, time_stamp: _time_stamp)
